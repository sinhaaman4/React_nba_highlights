...
const URL_TEAM_DETAIL='http://localhost:3004/teams'

class Team_detail extends React.Component{
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        fetch(`${URL_TEAM_DETAIL}?name=${this.props.match.params.id}`, {method:'GET'})
